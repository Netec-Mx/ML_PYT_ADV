...
Te damos la bienvenida a la **plataforma de laboratorios** del curso **Machine Learning con Python**. Aquí podrás explorar diferentes tecnologías a través de prácticas guiadas. ¡Desarrolla tus habilidades y lleva tus conocimientos al siguiente nivel!

## Lista de laboratorios

Cada uno de estos laboratorios está diseñado para ofrecerte una experiencia práctica. Haz clic en los enlaces para comenzar.

### [Práctica 1.1. Bases de Python y librerías esenciales](Capítulo1/README.md) 
